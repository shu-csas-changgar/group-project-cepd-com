...
urlpatterns = [
    ...
    path('displayEquipment/', views.displayEquipment, name="displayEquipment"),
    path('displayVendor/', views.displayEquipment, name="displayVendor"),
    path('displayUser/', views.displayEquipment, name="displayUser"),
