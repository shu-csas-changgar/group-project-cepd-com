...
urlpatterns = [
    ...
    path('activateEquipment/<int:equipmentId>', views.activateEquipment, name="activateEquipment"),
    path('activateVendor/<int:vendorId>', views.activateVendor, name="activateVendor"),
